        ...
        i.prototype.options = {
            ...
            i.prototype._init = function() {
                ...
                this.closeBtn.addEventListener("click", function(t) {
                    ...
                    this.mask.addEventListener("click", function(t) {
            ...
            i.prototype.close = function() {
                this.body.classList.remove("has-active-menu"),
                    ...
                    this.mask.classList.remove("is-active"), this.enableMenuOpeners()
            },
            i.prototype.disableMenuOpeners = function() {
                s(this.menuOpeners, function(t) { t.disabled = !0 })
            },
            i.prototype.enableMenuOpeners = function() {
                s(this.menuOpeners, function(t) { t.disabled = !1 })
            }, t.Menu = i
    }(window);
